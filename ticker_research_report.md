...
*High-Level Overview | April 14, 2026*

---

## 1. Bloom Energy (BE) — Public Stock
...
## 3. Sidus Space (SIDU) — Public Stock
...
## 4. Power Infrastructure ETFs — GRID & VOLT
...
## 5. Cerebras Systems — Private (IPO Pending)

Cerebras builds the world's largest AI chips, including the Wafer Scale Engine (WSE), which packs an entire wafer's worth of transistors into a single chip. The company competes directly with Nvidia in AI training and inference hardware.

### Key Facts

| Metric | Value |
|---|---|
| Latest Valuation | $23.1B (Series H, Feb 2026) |
| Total Funding | ~$2.9B across 8 rounds |
| 2023 Revenue | $78.7M |
| 2024 Revenue | ~$421M (estimated) |
| Key Deal | $10B+ compute agreement with OpenAI through 2028 |
| IPO Target | Q2 2026, Nasdaq (ticker: CBRS) |
...
## 9. Astera Labs (ALAB) — Public Stock
...
## 12. DRAM / Memory Chip ETF Basket — Public

The reference to a "DRAM ETF" most likely points to a memory-semiconductor thematic basket. As of April 2026 there is **no widely traded US ETF with the literal ticker `DRAM`** on a major exchange — this should be verified on a screener since Roundhill, Themes ETFs, and others have been launching narrow thematic products on a near-monthly cadence in 2024–2026, and a literal `DRAM` ticker may exist as a recent launch. Below is the practical exposure: which ETFs hold the memory pure-plays, which underlying names matter, and why memory has decoupled from broader semis.
